...
export const EpisodeModal = ({
  ...
  // Create refs array that scales with cardList
  ...
  return (
    <Dialog key={episode.ratingKey} open={episode.ratingKey !== null}>
      <DialogContent
      ...
      >
        ...
        {caching ? (
          ...
          cardList.map((card, index) => (
            <div className="flex flex-col gap-8 justify-center items-center" key={card.value}>
              <div>{card.label}</div>
              <figure>
